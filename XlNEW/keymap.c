...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Q,           KC_P,           KC_D,           KC_L,           KC_K,                                           KC_F,           KC_U,           KC_O,           KC_Y,           KC_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LCTL, KC_S),MT(MOD_LALT, KC_N),MT(MOD_LGUI, KC_T),MT(MOD_LSFT, KC_H),KC_G,                                           KC_M,           MT(MOD_RSFT, KC_A),MT(MOD_RGUI, KC_E),MT(MOD_LALT, KC_I),MT(MOD_RCTL, KC_SCLN),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           KC_B,           KC_J,                                           KC_V,           KC_QUOTE,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
