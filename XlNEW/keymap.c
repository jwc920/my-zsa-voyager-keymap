...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_AMPR,        KC_LCBR,        KC_LPRN,        KC_LBRC,        KC_PIPE,                                        KC_ASTR,        KC_RBRC,        KC_RPRN,        KC_RCBR,        KC_CIRC,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_EQUAL,       KC_COLN,        KC_QUES,                                        KC_MINUS,       KC_UNDS,        KC_QUOTE,       KC_DQUO,        KC_DLR,         KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_HASH,        KC_LABK,        KC_TILD,        KC_SLASH,       KC_GRAVE,                                       KC_PLUS,        KC_BSLS,        KC_PERC,        KC_RABK,        KC_PIPE,        KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
